...
private:
  ...
  std::vector<double> pi_bessel_zeros;
  std::vector<double> array_psi;
  std::vector<double> array_psi_J2;
  std::vector<double> array_bessel;
  std::vector<double> array_psip;
  std::vector<double> array_w;
  std::vector<double> array_product;
  std::vector<double> array_product_J2;
