...
/**
 * @file testApertureStatistics_integral_l2.cpp
 * This executable gives the l2 Integral of Eq. 58 in Schneider, Kilbinger & Lomabrdi (2003)
 * used for debugging
 * @author Laila Linke
 * @warning output is written in file "../tests/TestIntegralL2.dat"
...
int main()
{
  ...
  // Set up output
  std::ofstream out;
  out.open("../tests/TestIntegralL2.dat");


  // Set up thetas

  double theta=10./60./180.*3.1416; //10 arcmin in rad
  apertureStatistics.theta1_=2*theta;
