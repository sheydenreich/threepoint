...
int main()
{
  ...
  std::vector<double> thetas_123 = {thetas.at(i), thetas.at(j), thetas.at(k)};
  std::vector<double> thetas_456 = {thetas.at(ii), thetas.at(jj), thetas.at(kk)};
  double reference = apertureStatistics.MapMapMap_covariance_Gauss(thetas_123, thetas_456, survey_area);
  ...
  do
  {
    std::vector<double> thetas_123_perm = {thetas.at(index_123[0]), thetas.at(index_123[1]), thetas.at(index_123[2])};
    double permuted = apertureStatistics.MapMapMap_covariance_Gauss(thetas_123_perm, thetas_456, survey_area);
    std::cout << "(" << thetas_123_perm[0] << "," << thetas_123_perm[1] << "," << thetas_123_perm[2] << ";" << thetas_456[0] << "," << thetas_456[1] << "," << thetas_456[2] << "): " << (permuted / reference - 1.) * 100 << "\%, \t" << permuted << ", \t" << reference << std::endl;
  ...
  do
  {
    std::vector<double> thetas_456_perm = {thetas.at(index_456[0]), thetas.at(index_456[1]), thetas.at(index_456[2])};
    double permuted = apertureStatistics.MapMapMap_covariance_Gauss(thetas_123, thetas_456_perm, survey_area);
    std::cout << "(" << thetas_123[0] << "," << thetas_123[1] << "," << thetas_123[2] << ";" << thetas_456_perm[0] << "," << thetas_456_perm[1] << "," << thetas_456_perm[2] << "): " << (permuted / reference - 1.) * 100 << "\%,\t" << permuted << ",\t" << reference << std::endl;
  ...
  double permuted = apertureStatistics.MapMapMap_covariance_Gauss(thetas_456, thetas_123, survey_area);
  std::cout << (permuted / reference - 1.) * 100 << "\%,\t" << permuted << ",\t" << reference << std::endl;
