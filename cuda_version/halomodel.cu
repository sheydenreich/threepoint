...
{
  double didx = z / dev_z_max * (n_redshift_bins);
  int idx = didx;
  didx = didx - idx;
  ...
  double g_value_4 = g_interpolated(idx, didx, zbin4, dev_g, Ntomo);
  ...
  double W_4 = limber_integrand_prefactor_delta(z, g_value_4);
                                                ...
                                                double *dev_g, int Ntomo)
{
  ...
  q = 0;
  for (i = 0; i < 48; i++)
    q += dev_W96[i] * (trispectrum_integrand(m, cx - dx * dev_A96[i], l1, l2, l3, l4, zbin1, zbin2, zbin3, zbin4, dev_g, Ntomo) + trispectrum_integrand(m, cx + dx * dev_A96[i], l1, l2, l3, l4, zbin1, zbin2, zbin3, zbin4, dev_g, Ntomo));
  return (q * dx);
}
                                          ...
                                          double *dev_g, int Ntomo)
{
  ...
  double g_value_3 = g_interpolated(idx, didx, zbin3, dev_g, Ntomo);
  double g_value_4 = g_interpolated(idx, didx, zbin4, dev_g, Ntomo);
  double g_value_5 = g_interpolated(idx, didx, zbin5, dev_g, Ntomo);
  double g_value_6 = g_interpolated(idx, didx, zbin6, dev_g, Ntomo);

  double W_1 = limber_integrand_prefactor_delta(z, g_value_1);
  double W_2 = limber_integrand_prefactor_delta(z, g_value_2);
  double W_3 = limber_integrand_prefactor_delta(z, g_value_3);
  double W_4 = limber_integrand_prefactor_delta(z, g_value_4);
  double W_5 = limber_integrand_prefactor_delta(z, g_value_5);
  double W_6 = limber_integrand_prefactor_delta(z, g_value_6);
  ...
  double result = hmf(m, z) / pow(chi, 4);
  result *= dev_c_over_H0 / E(z);
  ...
  result *= W_1*W_2*W_3*W_4*W_5*W_6;
                                                  ...
                                                  double *dev_g, int Ntomo)
{
  ...
  for (int i = 0; i < 48; i++)
  {
    q += dev_W96[i] * (pentaspectrum_integrand(m, cx - dx * dev_A96[i], l1, l2, l3, l4, l5, l6, zbin1, zbin2, zbin3, zbin4, zbin5, zbin6, dev_g, Ntomo) 
    + pentaspectrum_integrand(m, cx + dx * dev_A96[i], l1, l2, l3, l4, l5, l6, zbin1, zbin2, zbin3, zbin4, zbin5, zbin6, dev_g, Ntomo));
  }
                                                       ...
                                                       double *dev_g, int Ntomo)
{
  ...
  for (int i = 0; i < 48; i++)
  {
    ...
    q += dev_W96[i] * (m1 * pentaspectrum_limber_integrated(zmin, zmax, m1, l1, l2, l3, l4, l5, l6, zbin1, zbin2, zbin3, zbin4, zbin5, zbin6, dev_g, Ntomo) 
    + m2 * pentaspectrum_limber_integrated(zmin, zmax, m2, l1, l2, l3, l4, l5, l6, zbin1, zbin2, zbin3, zbin4, zbin5, zbin6, dev_g, Ntomo));
  }
                                                      ...
                                                      double *dev_g, int Ntomo)
{
  ...
  for (int i = 0; i < 48; i++)
  {
    q += dev_W96[i] * (pentaspectrum_integrand_ssc(mmin, mmax, cx - dx * dev_A96[i], l1, l2, l3, l4, l5, l6, zbin1, zbin2, zbin3, zbin4, zbin5, zbin6, dev_g, Ntomo) 
    + pentaspectrum_integrand_ssc(mmin, mmax, cx + dx * dev_A96[i], l1, l2, l3, l4, l5, l6, zbin1, zbin2, zbin3, zbin4, zbin5, zbin6, dev_g, Ntomo));
  }
...
__device__ double powerspectrum_limber_integrated(double a, double b, double m, double l, int zbin1, int zbin2, double *dev_g, int Ntomo)
{
  ...
  q = 0;
  for (i = 0; i < 48; i++)
    q += dev_W96[i] * (powerspectrum_integrand(m, cx - dx * dev_A96[i], l, zbin1, zbin2, dev_g, Ntomo) 
    + powerspectrum_integrand(m, cx + dx * dev_A96[i], l, zbin1, zbin2, dev_g, Ntomo));
  return (q * dx);
}
...
int integrand_Powerspectrum(unsigned ndim, size_t npts, const double *vars, void *thisPtr, unsigned fdim, double *value)
{
  ...
  int zbin1 = container->zbin1;
  int zbin2 = container->zbin2;
  ...
  // Calculate values
  integrand_Powerspectrum_kernel<<<BLOCKS, THREADS>>>(dev_vars, ndim, npts, l, zbin1, zbin2, dev_g, Ntomo, dev_value);
...
__global__ void integrand_Powerspectrum_kernel(const double *vars, unsigned ndim, int npts, double l, int zbin1, int zbin2, double* dev_g, int Ntomo, double *value)
{
  ...
  for (int i = thread_index; i < npts; i += blockDim.x * gridDim.x)
  {
    ...
    value[i] = powerspectrum_limber_integrated(0, dev_z_max, m, l, zbin1, zbin2, dev_g, Ntomo);
  }
}
...
int integrand_Trispectrum(unsigned ndim, size_t npts, const double *vars, void *thisPtr, unsigned fdim, double *value)
{
  ...
  int zbin1 = container->zbin1;
  int zbin2 = container->zbin2;
  int zbin3 = container->zbin3;
  int zbin4 = container->zbin4;
  double * dev_g = container->dev_g;
  int Ntomo = container->Ntomo;
  ...
  // Calculate values
  integrand_Trispectrum_kernel<<<BLOCKS, THREADS>>>(dev_vars, ndim, npts, l1, l2, l3, l4, zbin1, zbin2, zbin3, zbin4, dev_g, Ntomo, dev_value);
...
__global__ void integrand_Trispectrum_kernel(const double *vars, unsigned ndim, int npts, double l1, double l2, double l3, double l4,
int zbin1, int zbin2, int zbin3, int zbin4, double* dev_g, int Ntomo, double *value)
{
  // index of thread
  int thread_index = blockIdx.x * blockDim.x + threadIdx.x;
  ...
  {
    double m = vars[i * ndim];
    value[i] = trispectrum_limber_integrated(0, dev_z_max, m, l1, l2, l3, l4, zbin1, zbin2, zbin3, zbin4, dev_g, Ntomo);
  }
}
...
double Trispectrum(const double &l1, const double &l2, const double &l3, const double &l4, int zbin1, int zbin2, int zbin3, int zbin4, double *dev_g, int Ntomo)
{
  ...
  container.zbin1 = zbin1;
  container.zbin2 = zbin2;
  container.zbin3 = zbin3;
  container.zbin4 = zbin4;
  container.dev_g = dev_g;
  container.Ntomo = Ntomo;
                     ...
                     int zbin1, int zbin2, int zbin3, int zbin4, int zbin5, int zbin6, double *dev_g, int Ntomo)
{
  ...
  container.zbin3=zbin3;
  container.zbin4=zbin4;
  container.zbin5=zbin5;
  container.zbin6=zbin6;
  container.dev_g=dev_g;
  container.Ntomo=Ntomo;
...
int integrand_Pentaspectrum(unsigned ndim, size_t npts, const double *vars, void *thisPtr, unsigned fdim, double *value)
{
  ...
  int zbin3=container->zbin3;
  int zbin4=container->zbin4;
  int zbin5=container->zbin5;
  int zbin6=container->zbin6;
  ...
  // Calculate values
  integrand_Pentaspectrum_kernel<<<BLOCKS, THREADS>>>(dev_vars, ndim, npts, l1, l2, l3, l4, l5, l6, zbin1, zbin2, zbin3, zbin4, zbin5, zbin6, dev_g, Ntomo, dev_value);
                                               ...
                                               double *value)
{
  ...
  for (int i = thread_index; i < npts; i += blockDim.x * gridDim.x)
  {
    ...
    value[i] = m * pentaspectrum_integrand(m, z, l1, l2, l3, l4, l5, l6, zbin1, zbin2, zbin3, zbin4, zbin5, zbin6, dev_g, Ntomo);
  }
}
                                                  ...
                                                  double *dev_g, int Ntomo)
{
  ...
  for (int i = 0; i < 48; i++)
  {
    q += dev_W96[i] * (tetraspectrum_integrand(m, cx - dx * dev_A96[i], l1, l2, l3, l4, l5, zbin1, zbin2, zbin3, zbin4, zbin5, dev_g, Ntomo) 
    + tetraspectrum_integrand(m, cx + dx * dev_A96[i], l1, l2, l3, l4, l5, zbin1, zbin2, zbin3, zbin4, zbin5, dev_g, Ntomo));
  }
