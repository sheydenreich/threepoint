...
from utility import aperture_mass_computer,extract_aperture_masses_of_field
import numpy as np
import sys
...
def compute_aperture_masses_of_field(los,theta_ap_array,save_map=None,use_polynomial_filter=False):
    ...
    result = extract_aperture_masses_of_field(field,npix,theta_ap_array,fieldsize,compute_mcross=False,save_map=save_map,use_polynomial_filter=use_polynomial_filter)
