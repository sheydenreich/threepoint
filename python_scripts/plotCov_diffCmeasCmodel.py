...
# Set Xaxes labels
grid[0].set_title(r"$2\,\frac{C_{\hat{M}_\mathrm{ap}^3}^\mathrm{meas}/32-C_{\hat{M}_\mathrm{ap}^3}^{\infty}}{C_{\hat{M}_\mathrm{ap}^3}^\mathrm{meas}/32 + C_{\hat{M}_\mathrm{ap}^3}^{\infty}}$", pad=40)
grid[1].set_title(r"$2\,\frac{C_{\hat{M}_\mathrm{ap}^3}^\mathrm{meas}/32-C_{\hat{M}_\mathrm{ap}^3}}{C_{\hat{M}_\mathrm{ap}^3}^\mathrm{meas}/32 + C_{\hat{M}_\mathrm{ap}^3}}$", pad=40)
