from aperture_mass_computer import Map2_Lognormal_Random_Field_parallelised
...
if(__name__ == '__main__'):
    ...
    # Do Calculation
    result = Map2_Lognormal_Random_Field_parallelised(power_spectrum_array, args.alpha, thetas=[2, 4, 8, 16], npix=args.npix,
