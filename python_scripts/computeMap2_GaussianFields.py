from aperture_mass_computer import Map2_Gaussian_Random_Field_parallelised
from scipy.interpolate import interp1d
import numpy as np
import argparse
from os.path import exists
from os import makedirs
docstring = """ Script for creating Gaussian Random Fields and extracting the Map2 from them.
"""
...
if(__name__ == '__main__'):
    ...
    # Do Calculation
    result = Map2_Gaussian_Random_Field_parallelised(power_spectrum_array, thetas=[2, 4, 8, 16], npix=args.npix,
