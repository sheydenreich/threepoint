...
from utility import extract_fourth_order_aperture_masses_of_field
import numpy as np
import sys
...
def compute_aperture_masses_of_field(los,theta_ap_array,save_map=None,use_polynomial_filter=False):
    ...
    result = extract_fourth_order_aperture_masses_of_field(field,npix,theta_ap_array,fieldsize,save_map=save_map,use_polynomial_filter=use_polynomial_filter, same_fieldsize_for_all_theta=True)
...
if(__name__=='__main__'):
    ...
    compute_all_aperture_masses(all_los,savepath+'/',n_processes=1,aperture_masses = [2,4, 8,16])
