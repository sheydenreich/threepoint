...
combis=fct.get_all_combis()[:60]
print(combis) 

cosmo_fname = store_path+'config_files/cosmo_IA.dat'
...
nz_files = [store_path+'config_files/nofz/nofz_KiDS1000_tomobin1_takashi.dat',
            store_path+'config_files/nofz/nofz_KiDS1000_tomobin2_takashi.dat',
            store_path+'config_files/nofz/nofz_KiDS1000_tomobin3_takashi.dat',
            store_path+'config_files/nofz/nofz_KiDS1000_tomobin4_takashi.dat',
            store_path+'config_files/nofz/nofz_KiDS1000_tomobin5_takashi.dat']
nz_files_name = nz_files[0]+' '+nz_files[1]+' '+nz_files[2]+' '+nz_files[3]+' '+nz_files[4]

sigma_epsilon = np.array([0.270,0.258,0.273,0.254,0.270])*np.sqrt(2)
...
cosmo = cosmology(h=0.7,sigma_8=0.82,Omega_m=0.279,w=-1.0,A_IA=0.0)
write_cosmo_file(fname=cosmo_fname,cosmo=cosmo)
output_file = store_path+'results/Map2_KiDS1000_full_model_1em4_centerbin_withnoise.dat'
start = time()
