...
$DIR_BIN/calculateMap6.x ../necessary_files/MR_cosmo.dat $FILE_THETAS $DIR_RESULTS/Map6_trispec 1 $FILE_NZ > test

#$DIR_BIN/calculatePowerspectrum_halomodel.x ../necessary_files/MR_cosmo.dat $DIR_RESULTS/Powerspec_halomodel 1 $FILE_NZ

#$DIR_BIN/calculateTrispectrum_halomodel.x ../necessary_files/MR_cosmo.dat $DIR_RESULTS/Trispec_halomodel 1 $FILE_NZ

#$DIR_BIN/calculatePentaspectrum_halomodel.x ../necessary_files/MR_cosmo.dat $DIR_RESULTS/Pentaspec_halomodel 1 $FILE_NZ
