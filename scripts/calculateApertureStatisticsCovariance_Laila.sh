...
DIR="../test_shapenoise/" #/home/laila/OneDrive/1_Work/5_Projects/02_3ptStatistics/Map3_Covariances/GaussianRandomFields_shapenoise/
mkdir -p $DIR
# T_1^\infty
...
DIR="../test_cosmicShear/" #/vol/euclid6/euclid6_ssd/sven/threepoint_with_laila/Map3_Covariances/GaussianRandomFields_cosmicShear/
mkdir -p $DIR
# T_1^\infty
