...
folder = "/home/laila/OneDrive/1_Work/5_Projects/02_3ptStatistics/Map3_Covariances/GaussianRandomFields_"+type+"/"
filename_in = f"map_cubed_from_gamma_npix_4096_fieldsize_{theta}_{Nlos}.npy"
filename_out = f"cov_{type}_fft_sigma_0.0_n_{n:.2f}_thetaMax_{thetaMax:.2f}.dat"
filename_out_uncertainty = f"covUncertainty_{type}_fft_sigma_0.0_n_{n:.2f}_thetaMax_{thetaMax:.2f}.dat"
...
data = np.load(folder+filename_in)
